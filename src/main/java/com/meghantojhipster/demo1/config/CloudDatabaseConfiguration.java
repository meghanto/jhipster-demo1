package com.meghantojhipster.demo1.config;
...
@Configuration
@EnableMongoRepositories("com.meghantojhipster.demo1.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.meghantojhipster.demo1.config.dbmigrations");
